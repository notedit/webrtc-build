...
"""WebRTC mac FAT libraries build script.
Each architecture is compiled separately before being merged together.
By default, the library is created in out_mac_libs/. (Change with -o.)
"""
...
SDK_OUTPUT_DIR = os.path.join(SRC_DIR, 'out_mac_libs')
SDK_FRAMEWORK_NAME = 'WebRTC.framework'

DEFAULT_ARCHS = ENABLED_ARCHS = ['x64','x86']
...
def BuildWebRTC(output_dir, target_arch, flavor, gn_target_name,
  ...
  gn_args = ['target_os="mac"', 'is_component_build=false']
